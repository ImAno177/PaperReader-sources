...
android { namespace = "dev.paperreader.extensions.sources.arxiv"; compileSdk = 37
    defaultConfig { applicationId = "dev.paperreader.extensions.sources.arxiv"; minSdk = 28; targetSdk = 36; versionCode = providers.gradleProperty("releaseVersionCode").orElse("1").get().toInt(); versionName = providers.gradleProperty("releaseVersion").orElse("0.1.0").get() }
