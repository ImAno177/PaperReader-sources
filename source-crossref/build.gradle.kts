...
android { namespace = "dev.paperreader.extensions.sources.crossref"; compileSdk = 36
    defaultConfig { applicationId = "dev.paperreader.extensions.sources.crossref"; minSdk = 28; targetSdk = 36; versionCode = providers.gradleProperty("releaseVersionCode").orElse("1").get().toInt(); versionName = providers.gradleProperty("releaseVersion").orElse("0.1.0").get(); buildConfigField("String", "PAPERREADER_HOST_SIGNER_SHA256", "\"$hostSigner\"") }
...
dependencies { implementation(project(":source-common")); implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.9.0"); implementation("org.jsoup:jsoup:1.23.1"); testImplementation("junit:junit:4.13.2") }
