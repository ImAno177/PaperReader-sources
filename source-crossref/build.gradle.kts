...
android { namespace = "dev.paperreader.extensions.sources.crossref"; compileSdk = 37
...
dependencies { implementation(project(":source-common")); implementation("org.jetbrains.kotlinx:kotlinx-serialization-json:1.11.0"); implementation("org.jsoup:jsoup:1.23.2"); testImplementation("junit:junit:4.13.2") }
