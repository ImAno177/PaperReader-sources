...
android { namespace = "dev.paperreader.extensions.sources.europepmc"; compileSdk = 36
    defaultConfig { applicationId = "dev.paperreader.extensions.sources.europepmc"; minSdk = 28; targetSdk = 36; versionCode = providers.gradleProperty("releaseVersionCode").orElse("1").get().toInt(); versionName = providers.gradleProperty("releaseVersion").orElse("0.1.0").get(); buildConfigField("String", "PAPERREADER_HOST_SIGNER_SHA256", "\"$hostSigner\"") }
